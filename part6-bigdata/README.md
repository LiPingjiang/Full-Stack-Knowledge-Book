...
- 如果你面试的岗位强调「数仓建设 + AI 赋能」（数仓智能体、Text2SQL、智能数据治理），除了 6.7/6.9/6.10 之外，重点看 6.19（元数据与智能治理）、6.18（TiDB/HTAP）以及 [第七章 7.8 AgentBI 智能分析](../part7-ai-engineering/08-AgentBI智能分析.md)，三者合起来是这类岗位的完整知识图谱
