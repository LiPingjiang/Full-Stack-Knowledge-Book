...
- [7.12 案例研究：点富科技「大模型数据工程与评测岗」深度分析——公司背景核验 / 专家数字分身技术拆解 / persona 数据构建 / CharacterEval / LLM-as-a-Judge 校准 / 医疗合规 / **数据体系 0→1 建设规划** / **赛道标尺与研发模式** / **产品定位诊断（市场漏斗数据·B端破局）** / **监管边界专题（21号令三要件·中美欧英对比·合规资质清单）** / **实证核查（现有产品落在监管哪一侧）** / 28 道预测题 / 23 个反问](./part7-ai-engineering/12-案例-点富科技大模型数据评测岗.md)
