...
| 项目 | 语言 | 特征 |
|---|---|---|
| Jupyter Notebook v7 | TypeScript + Python | JupyterLab 组件单文档封装，Lumino Widget |
| marimo | Python + React | 响应式 DAG，纯 Python 存储，AI 原生 |
| Apache Zeppelin | Java/Scala | Thrift RPC，Interpreter 架构，大数据导向 |
| Polynote | Scala | gRPC + Protobuf，混合语言 Cell |
| Observable Runtime | JavaScript | 纯浏览器执行，响应式数据流 |
| Pluto.jl | Julia | 响应式 Notebook 鼻祖，marimo 灵感来源 |
| ipyflow | Python | Jupyter 的响应式 Kernel，数据流追踪 |
| Starboard | TypeScript | 纯浏览器 Notebook，可嵌入 |
